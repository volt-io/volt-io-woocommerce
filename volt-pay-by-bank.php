...
function init_gateway_voltio()
{
	...
	load_plugin_textdomain('voltio', false, dirname(plugin_basename(__FILE__)) . '/lang/');
...
function use_geolocated_user_country(){
...
{
	wp_enqueue_script('voltio_gateway_js', plugin_dir_url(__FILE__) . 'views/js/main.js', array(), time(), true);
